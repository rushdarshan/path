# Final Prompt — Pathlight × Career Dreamer Intro Funnel
...
- Zero Generic Language scan: passed
...
- `plans/01-site-dna.md` — Career Dreamer Site DNA (high-fidelity, new)
- `plans/01-site-dna.lets-code.md` — archived lets-code DNA
- `plans/02-brand-interview.md` — Dreamer intro brand interview (inferred from Pathlight)
- `plans/03-replication-prompt.md` — replication prompt
- `plans/04-final-prompt.md` — this file
