# Final Prompt — Pathlight Resume Panel (lets-code.co.in Clone)

AUDIT_MODE: high-fidelity
Quality checklist: PASSED (2026-08-30)
...
- HF Fidelity Domains: Layout ✓ / Visual Composition ✓ / Animation ✓ / Interaction ✓ / Design System ✓ / Technical ✓
- Zero Generic Language scan: passed (patched ease → cubic-bezier, scroll N/A clarified)

---

## The Verified Replication Prompt

(Paste-ready. Identical to 03-replication-prompt.md after Phase 4 patches. Structure: Role → Design System → Component Architecture → Technical Requirements → Execution Directive.)
...
- `plans/01-site-dna.md` — Site DNA (high-fidelity)
- `plans/02-brand-interview.md` — Brand interview (inferred from your existing Pathlight build)
- `plans/03-replication-prompt.md` — Replication prompt (patched for HF checklist)
- `plans/04-final-prompt.md` — This file (verified)